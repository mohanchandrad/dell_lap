...
const Contact = () => {
    ...
    return (
        ...
        <>
            <div id="contact" className="mt-4 mb-5 py-5" style={{backgroundColor: '#fbfbfb'}}>
                        ...
                        <div className="col-md-6">
                            <form action="">
                                ...
                                <div className="input-box">
                                    ...
                                    <textarea name=""  placeholder="Message" id="" cols="30" rows="5" className="form-control"></textarea>
                                </div>

                                <div className="button">
                                    <button className="btn btn-primary btns mt-4">Send The Message</button>
                                </div>
                                </div>
                            </form>
                        </div>
